...
print("Fetch done")
curnifty = {"cur_val":nifty_fetched, "all_time_high":nifty_high,"down_per":change_per,"date":td,"time":current_time,"url":site}
db.nifty.insert_one(curnifty)
...
for x in mylist:
    cmpny = {"cmpny_name":x[0], "cmpny_price":x[1],"cmpny_high":x[2],"change_per":x[3],"url":x[4]}
    db.toptwenty.insert_one(cmpny)
